...
#    model.seqlen = seqlen  #TODO
    ...
    torch.save(acts_v, f"/data/zeyu/cq/mistralInstruct/kv/cache_v.pth")
    torch.save(acts_k, f"/data/zeyu/cq/mistralInstruct/kv/cache_k.pth")
    torch.save(grads_v, f"/data/zeyu/cq/mistralInstruct/fisher/grad_v.pth")
    torch.save(grads_k, f"/data/zeyu/cq/mistralInstruct/fisher/grad_k.pth")
